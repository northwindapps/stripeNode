...
//forget orders api. use checkout instead for one-time purchase.
// checkout complys with eu standards.
//https://stripe.com/docs/payments/checkout not for mobile app
// https://stripe.com/docs/api/checkout/sessions not for mobile app
// https://stripe.com/docs/api/payment_intents This is the only option.
// https://stripe.com/docs/api/products
// server.get('/skus', async (req, res) => {
//     //https://stripe.com/docs/api/products/list
...
server.post('/checkout', async (req, res) => {
    ...
    //TODO Update sku number before proceed the following process.
